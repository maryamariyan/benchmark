...
namespace hwapp
{
    ...
    [Serializable]
    public class BB<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>, ISerializable, IDeserializationCallback
    {
        ...
        public BB() : this(0, null) { }

        public BB(int capacity) : this(capacity, null) { }

        public BB(IEqualityComparer<TKey> comparer) : this(0, comparer) { }

        public BB(int capacity, IEqualityComparer<TKey> comparer)
        {
            if (capacity < 0)
        ...
        public BB(IDictionary<TKey, TValue> dictionary) : this(dictionary, null) { }

        public BB(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer) :
            this(dictionary != null ? dictionary.Count : 0, comparer)
        {
            ...
            // It is likely that the passed-in dictionary is BB<TKey,TValue>. When this is the case,
            // avoid the enumerator allocation and overhead by looping through the entries array directly.
            // We only do this when dictionary is BB<TKey,TValue> and not a subclass, to maintain
            // back-compat  subclasses that may have overridden the enumerator behavior.
            if (dictionary.GetType() == typeof(BB<TKey, TValue>))
            {
                BB<TKey, TValue> d = (BB<TKey, TValue>)dictionary;
                int count = d._count;
        ...
        public BB(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, null) { }

        public BB(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer) :
        ...
        protected BB(SerializationInfo info, StreamingContext context)
        {
        ...
        {
            private BB<TKey, TValue> _dictionary;
            private int _version;
            private int _index;
            ...
            internal Enumerator(BB<TKey, TValue> dictionary, int getEnumeratorRetType)
            {
        ...
        public sealed class KeyCollection : ICollection<TKey>, ICollection, IReadOnlyCollection<TKey>
        {
            ...
            public KeyCollection(BB<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
            ...
            public struct Enumerator : IEnumerator<TKey>, System.Collections.IEnumerator
            {
                ...
                internal Enumerator(BB<TKey, TValue> dictionary)
                {
                    _dictionary = dictionary;
                    _version = dictionary._version;
                    _index = 0;
        ...
        public sealed class ValueCollection : ICollection<TValue>, ICollection, IReadOnlyCollection<TValue>
        {
            ...
            public ValueCollection(BB<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                {
                    throw new Exception(); //ThrowHelper.ThrowArgumentNullException(ExceptionArgument.dictionary);
